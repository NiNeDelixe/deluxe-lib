...
// configuration step. It creates a namespace called `deluxe_lib`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", deluxe_lib::cmake::project_name, deluxe_lib::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", deluxe_lib::cmake::project_version);
      return EXIT_SUCCESS;
    }
