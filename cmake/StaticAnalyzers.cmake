# Sets up consistent warning messages for missing static analysis tools
macro(deluxe_lib_tool_not_found_warning TOOL_NAME)
  message(${deluxe_lib_WARNING_TYPE} "${TOOL_NAME} was requested but executable was not found. Please install ${TOOL_NAME} to enable this feature.")
endmacro()

macro(deluxe_lib_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    deluxe_lib_tool_not_found_warning("cppcheck")
  endif()
endmacro()

macro(deluxe_lib_enable_clang_tidy target WARNINGS_AS_ERRORS)
  ...
  if(CLANGTIDY)
    ...
    deluxe_lib_tool_not_found_warning("clang-tidy")
  endif()
endmacro()

macro(deluxe_lib_enable_include_what_you_use)
  find_program(INCLUDE_WHAT_YOU_USE include-what-you-use)
  if(INCLUDE_WHAT_YOU_USE)
    set(CMAKE_CXX_INCLUDE_WHAT_YOU_USE ${INCLUDE_WHAT_YOU_USE})
  else()
    deluxe_lib_tool_not_found_warning("include-what-you-use")
  endif()
endmacro()

macro(deluxe_lib_enable_lizard WARNINGS_AS_ERRORS)
  find_program(LIZARD lizard)
  if(LIZARD)
    include(cmake/Lizard.cmake)
    # Function defined in Lizard.cmake
    deluxe_lib_setup_lizard(${WARNINGS_AS_ERRORS})
  else()
    deluxe_lib_tool_not_found_warning("lizard")
  endif()
endmacro()

# Enable Bloaty McBloatface for binary size analysis
macro(deluxe_lib_enable_bloaty)
  ...
  if(BLOATY)
    ...
    deluxe_lib_tool_not_found_warning("bloaty")
  endif()
endmacro()
