...
function(deluxe_lib_setup_bloaty TARGET_NAME)
  ...
  if(BLOATY)
    ...
    message(${deluxe_lib_WARNING_TYPE} "Bloaty McBloatface requested but executable not found. Install with 'apt install bloaty' or from https://github.com/google/bloaty")
  endif()
endfunction()

# Function to add bloaty analysis to all executable targets
function(deluxe_lib_enable_bloaty)
  find_program(BLOATY bloaty)
  if(BLOATY)
    ...
    foreach(TARGET_NAME ${ALL_TARGETS})
      deluxe_lib_setup_bloaty(${TARGET_NAME})
